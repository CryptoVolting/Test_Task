...
func (r *OperatorPostgres) Create(operator testProject.Operator) (string, error) {
	var id string
...
func (r *OperatorPostgres) GetAll() ([]testProject.Operator, error) {
	var lists []testProject.Operator
...
func (r *OperatorPostgres) GetById(id string) (testProject.Operator, error) {
	var operator testProject.Operator
...
func (r *OperatorPostgres) UpdateById(operatorId string, operatorUpdate testProject.UpdateOperatorInput) error {
